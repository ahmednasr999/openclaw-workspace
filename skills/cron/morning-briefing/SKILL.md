...
7. The script handles EVERYTHING: Notion page, data, formatting, dashboard
...
## Error Handling
- First retry: Run script again (transient failures)
- Notion API error: Wait 10s, retry once
- Auth/token error: Report "Auth issue - check credentials"
- Data error: Send partial briefing if possible
- Final failure: Send error details to Telegram

## Quality Gates
- Script must exit 0 for success
- Output sent verbatim (no modification)
