...
4. **Verify**: Generate preview as `slide-XX-preview.pptx`. Extract text with `python3 scripts/document-to-markdown.py slide-XX-preview.pptx`, verify all content present and no placeholder text remains.
