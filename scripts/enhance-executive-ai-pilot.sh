...
input_video="${1:-/root/.openclaw/media/ahmed-nasr-executive-ai-pilot-corrected.mp4}"
output_video="${2:-$workspace_dir/output/video-enhanced/ahmed-nasr-executive-ai-pilot-enhanced.mp4}"
subtitle_file="$workspace_dir/output/video-enhanced/ahmed-executive-ai-pilot-enhanced.ass"
