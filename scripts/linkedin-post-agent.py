...
def load_reference_posts(limit_chars=1200):
    """Load reference posts for briefing context."""
    ref_path = Path("/root/.openclaw/workspace/memory/linkedin-reference-posts.md")
