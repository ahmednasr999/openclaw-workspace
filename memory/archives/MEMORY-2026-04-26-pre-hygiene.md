...
**Content Pipeline Columns:** <!-- stale-check 2026-04-23 -->
- 💡 Ideas → 📝 Outline → ✍️ Draft → 🎨 Design → 👀 Review → ✅ Published

**Approval Flow:** <!-- stale-check 2026-04-23 -->
...
## Operating Baseline (Confirmed 2026-04-07, superseded by GPT-5.5 on 2026-04-24) <!-- stale-check 2026-04-26 -->

### Model Stack
- Historical primary then: `openai-codex/gpt-5.4` via ChatGPT Pro OAuth. Current primary is documented in `USER.md` and `TOOLS.md`.
- Historical fallback then: `minimax-portal/MiniMax-M2.7`
