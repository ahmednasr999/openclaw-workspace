...
|---|---|---|---|
| Tier 1 | Static validation | **PASSED WITH OBSERVATIONS** | 6 validator(s); 15 finding(s) |
...
- **MEDIUM** QUALITY/quality\_discoverability: Description uses first/second person (`SKILL.md`)
