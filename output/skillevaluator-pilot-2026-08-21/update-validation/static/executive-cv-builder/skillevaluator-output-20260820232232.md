...
| ❌ Failed | 1 |
| ⚠️ Incomplete | 0 |
| Total Issues | 17 (1 high, 5 medium) |
...
- [OK] **line_count**: SKILL.md within line limit (110/500)
...
| Severity | Issue | Location |
|----------|-------|----------|
| [HIGH] HIGH | Non-placeholder email address: ahmednasr999@gmail.com | <code>SKILL.md:4</code> |
...
- File: `SKILL.md:4`
- Check: `emails`
- Content: `metadata: {"author":"Ahmed Nasr <ahmednasr999@gmail.com>"...`
