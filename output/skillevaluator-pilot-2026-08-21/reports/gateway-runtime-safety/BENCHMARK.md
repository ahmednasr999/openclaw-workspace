...
|---|---|---|---|
| Tier 1 | Static validation | **FAILED** | 6 validator(s); 14 finding(s) |
...
- **LOW** SCHEMA/unexpected\_file: Unexpected 'checklists' in skill root (`checklists`)
- **LOW** SCHEMA/unexpected\_file: Unexpected 'SKILL.md.bak-20260525-approved-escalation' in skill root (`SKILL.md.bak-20260525-approved-escalation`)
