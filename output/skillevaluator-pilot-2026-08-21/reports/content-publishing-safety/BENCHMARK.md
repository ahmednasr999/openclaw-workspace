# Skill Benchmark: content-publishing-safety
...
|---|---|---|---|
| Tier 1 | Static validation | **FAILED** | 6 validator(s); 13 finding(s) |
...
- **LOW** SCHEMA/unexpected\_file: Unexpected 'examples' in skill root (`examples`)
